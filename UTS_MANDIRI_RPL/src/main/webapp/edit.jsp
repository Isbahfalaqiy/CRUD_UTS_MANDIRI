...
Phone:<input type="text" name="phone" value="<%=obj_User_Bean.getPhone()%>"><br>
Email:<input type="text" name="email" value="<%=obj_User_Bean.getEmail()%>"><br>
Hire_date:<input type="text" name="hire_date" value="<%=obj_User_Bean.getHire_date()%>"><br>
Salary:<input type="text" name="salary" value="<%=obj_User_Bean.getSalary()%>"><br>
Job_title:<input type="text" name="job_title" value="<%=obj_User_Bean.getJob_title()%>"><br>
